...
public class Item extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4944698595479060002L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Item\",\"namespace\":\"com.gallegos.shop.domain.generated\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"float\"}]}");
   ...
   */
  public Item(java.util.UUID id, java.lang.CharSequence name, java.lang.Integer quantity, java.lang.Float price) {
    this.id = id;
    this.name = name;
   ...
   */
  public static com.gallegos.shop.domain.generated.Item.Builder newBuilder() {
    return new com.gallegos.shop.domain.generated.Item.Builder();
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static com.gallegos.shop.domain.generated.Item.Builder newBuilder(com.gallegos.shop.domain.generated.Item.Builder other) {
    if (other == null) {
      return new com.gallegos.shop.domain.generated.Item.Builder();
    } else {
      return new com.gallegos.shop.domain.generated.Item.Builder(other);
    }
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static com.gallegos.shop.domain.generated.Item.Builder newBuilder(com.gallegos.shop.domain.generated.Item other) {
    if (other == null) {
      return new com.gallegos.shop.domain.generated.Item.Builder();
    } else {
      return new com.gallegos.shop.domain.generated.Item.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Item>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.gallegos.shop.domain.generated.Item.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.gallegos.shop.domain.generated.Item other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gallegos.shop.domain.generated.Item.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gallegos.shop.domain.generated.Item.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gallegos.shop.domain.generated.Item.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gallegos.shop.domain.generated.Item.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gallegos.shop.domain.generated.Item.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gallegos.shop.domain.generated.Item.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gallegos.shop.domain.generated.Item.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gallegos.shop.domain.generated.Item.Builder clearPrice() {
